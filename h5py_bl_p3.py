...
Last modified: 4/26/2021 12:08:10 AM
"""
...
pattern10off = "LN_150pF_CDP3_P4FE_se_100pA_9001410bufoff_P2ADC_se_asicdac08"
...
#
                if i%16 ==0: 
                    ...
                    plt.plot(x[0:100]*0.5,np.concatenate((ay[30:80],ay[280:330])),  marker = '.', label= "AMP = {}".format(int(np.max(ay[0:100]) - np.mean(tmp))), color = "C{}".format(abc))
                    plt.legend()
...
plt.tight_layout()
#plt.show()
plt.savefig(frst+fp[0:-3] + "wfm_avg_bl.png")
plt.close()
