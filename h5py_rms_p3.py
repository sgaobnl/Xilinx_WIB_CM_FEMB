...
Last modified: 4/26/2021 1:20:27 AM
"""
...
#fdir = "D:/CM_FEMB_P2/Rawdata0409"
rt_fp05 = "RT_150pF_CDP3_P4FE_se_100pA_9001405bufoff_P2ADC_se_RMS.h5"
rt_fp10 = "RT_150pF_CDP3_P4FE_se_100pA_9001410bufoff_P2ADC_se_RMS.h5"
rt_fp20 = "RT_150pF_CDP3_P4FE_se_100pA_9001420bufoff_P2ADC_se_RMS.h5"
rt_fp30 = "RT_150pF_CDP3_P4FE_se_100pA_9001430bufoff_P2ADC_se_RMS.h5"
ln_fp05 = "LN_150pF_CDP3_P4FE_se_100pA_9001405bufoff_P2ADC_se_RMS.h5"
ln_fp10 = "LN_150pF_CDP3_P4FE_se_100pA_9001410bufoff_P2ADC_se_RMS.h5"
ln_fp20 = "LN_150pF_CDP3_P4FE_se_100pA_9001420bufoff_P2ADC_se_RMS.h5"
ln_fp30 = "LN_150pF_CDP3_P4FE_se_100pA_9001430bufoff_P2ADC_se_RMS.h5"

#fdir = "D:/CM_FEMB_P2/Rawdata/"
#frst = "D:/CM_FEMB_P2/results/"
#rt_fp05 = "RT_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_05_RMS_bl200_sts_femb0.bin"
#rt_fp10 = "RT_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_10_RMS_bl200_sts_femb0.bin"
#rt_fp20 = "RT_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_20_RMS_bl200_sts_femb0.bin"
#rt_fp30 = "RT_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_30_RMS_bl200_sts_femb0.bin"
#ln_fp05 = "LN_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_05_RMS_bl200_sts_femb0.bin"
#ln_fp10 = "LN_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_10_RMS_bl200_sts_femb0.bin"
#ln_fp20 = "LN_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_20_RMS_bl200_sts_femb0.bin"
#ln_fp30 = "LN_150pF_P4FE_se_100pA_bufoff_P2_ADC_se_14_30_RMS_bl200_sts_femb0.bin"
...
for i in range(4):
    ...
    if i == 0:
        ...
        tp = "3.0us"
    plt.plot((np.array(chnos)-128*0)[128*0:128*1], rmss[128*0:128*1],  marker = 'x', color ="C%d"%i, label="RT, 14mV/fC, " + tp)
    ...
    if i == 0:
        ...
        tp = "3.0$\mu$s"
    plt.plot((np.array(chnos)-128*0)[128*0:128*1], rmss[128*0:128*1],  marker = 'o', color ="C%d"%(i+4), label="LN, 14mV/fC, " + tp)
...
for tmp in rmss_tp:
    if tmp[0] == "RT":
        m = np.mean(tmp[2][0:64])
        std = np.std(tmp[2][0:64])
        rt_rmsm[tmp[1]] = m
        rt_rmsstd[tmp[1]] = std 
    elif tmp[0] == "LN":
        m = np.mean(tmp[2][0:64])
...
import pickle
lnfg = fdir + "RT_150pF_CDP3_P4FE_se_100pA_2001410bufoff_P2ADC_se_asicdac04_sts_femb0_rt_gain_dis.bin"
rtfg = fdir + "RT_150pF_CDP3_P4FE_se_100pA_2001410bufoff_P2ADC_se_asicdac04_sts_femb0_rt_gain_dis.bin"
