...
Last modified: 10/23/2021 4:32:00 PM
"""
...
fdir = "D:/Monolithic_FEMB/Rawdata_1021/"
frst = fdir +  "results/"
...
#rt_fp20 = "RT_150pF_BRD01_CDP3_ADCP2SEON_FEP5SEOFF_500pA_200BL1420_RMS_S16ON.h5"
...
#rt_fp05 = "RT_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1405_RMS_S16ON.h5"
#rt_fp10 = "RT_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1410_RMS_S16ON.h5"
#rt_fp20 = "RT_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1420_RMS_S16ON.h5"
#rt_fp30 = "RT_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1430_RMS_S16ON.h5"
rt_fp05 = "LN_150pF03_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1405_RMS_S16ON.h5"
rt_fp10 = "LN_150pF03_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1410_RMS_S16ON.h5"
rt_fp20 = "LN_150pF03_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1420_RMS_S16ON.h5"
rt_fp30 = "LN_150pF03_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1430_RMS_S16ON.h5"

ln_fp05 = "LN_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1405_RMS_S16ON.h5"
ln_fp10 = "LN_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1410_RMS_S16ON.h5"
ln_fp20 = "LN_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1420_RMS_S16ON.h5"
ln_fp30 = "LN_150pFMICA_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_900BL1430_RMS_S16ON.h5"
...
for i in range(4):
    ...
    #plt.plot((np.arraggy(chnos)-128*0), rmss,  marker = 'x', color ="C%d"%i, label="RT, BL200mV, 14mV/fC, " + tp)
    #plt.plot((np.array(chnos)-128*0), rmss,  marker = 'x', color ="C%d"%i, label="RT, 150pF MICA, MC12FA151J-F, 5% " + tp)
    if (i ==2) or (i==0):
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="RT, 150pF NP0, 12101U151FAT2A, 1% " + tp)
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="RT, 150pF NP0, GCM31A5C3A151FX01D, 1% " + tp)
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="RT, 150pF NP0, C1206C151G5GACTU, 2% " + tp)
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="RT, 150pF NP0, 1210N151J202CT, 5% " + tp)

        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="LN, 150pF NP0, 12101U151FAT2A, 1% " + tp)
        plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="LN, 150pF NP0, GCM31A5C3A151FX01D, 1% " + tp)
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="LN, 150pF NP0, C1206C151G5GACTU, 2% " + tp)
        #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="LN, 150pF NP0, 1210N151J202CT, 5% " + tp)
    ...
    #plt.plot((np.array(chnos)-128*0), rmss,  marker = '.', color ="C%d"%i, label="RT, 150pF NP0, 12101u151FAT2A, 1% " + tp)
    if (i ==2) or (i==0):
        plt.plot((np.array(chnos)-128*0), rmss,  marker = 'x', color ="C%d"%(9-i), label="RT, 150pF MICA, MC12FA151J-F, 5% " + tp)
...
#        ttmp = tmp[2][:64] + tmp[2][112:128]
        ...
        ln_rmsm[tmp[1]] = m
        ln_rmsstd[tmp[1]] = std 
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="RT, 12101u151FAT2A", color='r', marker='o')
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="RT, GCM31A5C3A151FX01D", color='r', marker='o')
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="RT,  C1206C151G5GACTU", color='r', marker='o')
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="RT,  1210N151J202CT", color='r', marker='o')
#plt.errorbar(x, ln_rmsm, ln_rmsstd, label="RT, MC12FA151J-F", color='b', marker='^')

#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="LN, 12101u151FAT2A", color='r', marker='o')
plt.errorbar(x, rt_rmsm, rt_rmsstd, label="LN, GCM31A5C3A151FX01D", color='r', marker='o')
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="LN,  C1206C151G5GACTU", color='r', marker='o')
#plt.errorbar(x, rt_rmsm, rt_rmsstd, label="LN,  1210N151J202CT", color='r', marker='o')
plt.errorbar(x, ln_rmsm, ln_rmsstd, label="LN, MC12FA151J-F", color='b', marker='^')

for i in range(4):
    plt.text(x[i]-0.1, rt_rmsm[i]-0.8, "%.3f"%rt_rmsm[i])
for i in range(4):
    plt.text(x[i]-0.1, ln_rmsm[i]+0.5, "%.3f"%ln_rmsm[i])
...
lnfg = frst + "LN_000pF_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_200BL1420_ADAC0x08_S16O_gain_dis.bin"
rtfg = frst + "RT_000pF_BRD01_CDP3_ADCP2SEOFF_FEP5SEOFF_500pA_200BL1420_ADAC0x08_S16O_gain_dis.bin"
